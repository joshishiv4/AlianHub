...
* Proof of Concept (PoC)
  ...
  * The PoC must demonstrate real impact (e.g. access to sensitive data).
    Simple alert popups or theoretical issues may not be considered valid vulnerabilities.
